...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($title) || empty($description) || empty($location) || empty($company)) {
        ...
        $update_query = "UPDATE jobs SET title = ?, description = ?, location = ?, company = ? WHERE id = ?";
        $update_stmt = mysqli_prepare($conn, $update_query);
        mysqli_stmt_bind_param($update_stmt, "ssssi", $title, $description, $location, $company, $id);
...
<body>
    <div class="edit-job-container">
        ...
        <form method="POST" action="edit_job.php?id=<?= $id ?>">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" required><?= htmlspecialchars($job['description']) ?></textarea>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const container = document.querySelector('.edit-job-container');
